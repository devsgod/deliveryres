...
export class TrackerPage implements OnInit {
  ...
  getOrder() {
    ...
    this.api.getOrderById(this.id).then((data) => {
      ...
      if (data) {
        ...
        this.startNavigating(parseFloat(data.address.lat), parseFloat(data.address.lng), parseFloat(data.vid.lat), parseFloat(data.vid.lng));
      }
  ...
  startNavigating(latOri, lngOri, latDest, lngDest){
    ...
    var hideNaviData = setInterval(function(){ 
      var origin: any = document.getElementsByClassName("adp-placemark")[0];
      if (origin){
        var destination: any = document.getElementsByClassName("adp-placemark")[1];
        var copyright: any = document.getElementsByClassName("adp-legal")[0];
        var directions: any = document.getElementsByClassName("adp-directions")[0];
        var summary: any = document.getElementsByClassName("adp-summary")[0];
        copyright.style.display = "none";
        destination.style.display = "none";
        origin.style.display = "none";
        directions.style.display = "none";
        clearInterval(hideNaviData);
      }      
    }, 100);
  }
}
